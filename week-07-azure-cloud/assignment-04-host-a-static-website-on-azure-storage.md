...
![alt text](screenshots/week-07-assgn-04-1.png)
...
https://minifinance99.z13.web.core.windows.net
...
- [✔️] Mini Finance project downloaded and extracted
- [✔️] Storage Account created with Static Website Hosting enabled
- [✔️] All website files uploaded to the `$web` container
- [✔️] Website verified through the primary endpoint (Screenshot 1)
- [✔️] Website URL included
