...
4. Report the following:
   ...
   - Latest run ID for each pipeline
   - Every WARN or FAIL result
   - The exact sanitized log evidence supporting each result
   ...
   - One specific, actionable fix recommendation for the human to review
