...
![alt text](screenshots/as05-img-1.png)
...
![alt text](screenshots/as05-img-2.png)

![alt text](screenshots/as05-img-3.png)
...
![alt text](screenshots/as05-img-4.png)
...
![alt text](screenshots/as05-img-5.png)

---

#### Screenshot 5 — Output of `git commit`

![alt text](screenshots/as05-img-6.png)
...
![alt text](screenshots/as05-img-11.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![alt text](screenshots/as05-img-12.png)

---

#### Pull Request URL

https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/428
...
https://www.linkedin.com/posts/saima-usman_git-github-versioncontrol-share-7487505442915561473-4D4s/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABsfrYoBkq_t-PkQCt7fEB9Ajmp98YTHl_g

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![alt text](screenshots/as05-img-13.png)
...
https://github.com/Saima-Devops/devops-micro-internship-interviews

---

# Completion Checklist

- [✔️] Upstream repository forked to your GitHub account (Screenshot 1)
- [✔️] GitHub authentication configured securely (Screenshot 2)
- [✔️] Fork cloned locally with `origin` and `upstream` configured (Screenshot 3)
- [✔️] Only `pull_request.md` modified, with your own entry added (Screenshots 4–5)
- [✔️] Local default branch synchronized with `upstream/main`, feature branch rebased and pushed (Screenshots 6–7)
- [✔️] Pull Request opened against the correct upstream repository and branch (Screenshots 8–9)
- [✔️] Fork URL and Pull Request URL included
- [✔️] LinkedIn post published and URL submitted
- [✔️] No PAT, password, private key, or authentication secret exposed
